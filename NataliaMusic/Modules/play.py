...
from NataliaMusic.config import ARQ_API_KEY
...
async def play(_, message: Message):
            ...
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        ...
                        "\n\nor manually add [assistant](https://t.me/nataliahelpersehathperera01) to your Group and try again</b>",
                    )
    try:
    ...
    if chat_id in callsmusic.active_chats:
        ...
        await message.reply_photo(
            photo="final.png",
            reply_markup=keyboard,
            caption="▶️ <b>Playing</b> here the song requested by {} via Natalia Music ⚡️".format(message.from_user.mention()),
        )
        os.remove("final.png")
        return await lel.delete()
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your group due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @nataliahelpersehathperera01 to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
...
async def lol_cb(b, cb):
    ...
    if chat_id in callsmusic.active_chats:
        ...
        await b.send_photo(chat_id,
            photo="final.png",
            reply_markup=keyboard,
            caption=f"▶️ <b>Playing</b> here the song requested by {r_by.mention} via Natalia Music ⚡",
        )
